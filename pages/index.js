...
export default function Home() {
  ...
  return (
    <div className='bg-[#191516] w-full h-screen'>
      <div id='navbar' className='flex p-5 desc text-white justify-between items-center w-full'>
        <div className='w-1/4'>
          <svg className='stroke-[#FC7944]' width="64" height="64" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            <path fill="none" stroke-linecap="round" stroke-linejoin="round" d="M38.874 26.237L35 24l3.874-2.237a5.5 5.5 0 0 0-5.5-9.526L29.5 14.474V10a5.5 5.5 0 0 0-11 0v4.474l-3.874-2.237a5.5 5.5 0 0 0-5.5 9.526L13 24l-3.874 2.237a5.5 5.5 0 0 0 5.5 9.526l3.874-2.237V38a5.5 5.5 0 0 0 11 0v-4.474l3.874 2.237a5.5 5.5 0 0 0 5.5-9.526M18.5 14.474L35 24m-16.5 9.526L35 24" />
          </svg>
        </div>
